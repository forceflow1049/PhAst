...
;-----------------------------------------------------------------------------------------
pro phast_read_filters ;read the phast.filters file containing filter passband characteristics used in photometry
  ...
  function phast_get_stars, a, d, radius, AsOf=AsOf, catalog_name=catalog_name
    ...
    ;routine to retrieve stars from an outside catalog and format into phaset structure
...
;----------------------------------------------------------------------
; this processes user interactions with the point-click photometry GUI
